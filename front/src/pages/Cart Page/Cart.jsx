      ...
      <section className="mt-[80px] flex-1 items-center">
        {products.length > 0 ? (
                  ...
                  <div className="w-screen max-w-lg space-y-4">
                    ...
                    <div className="flex justify-between">
                      <button
                        ...
                        className="bg-transparent transition hover:bg-[#458106] text-black font-semibold hover:text-white py-2 px-4 border border-primary hover:border-transparent rounded"
                      >
                        Back
                      </button>
                      <Link
          ...
          <div className="h-60 flex flex-col items-center justify-center my-52 ">
            <h1 className="text-[25px] font-bold my-8">
              Your cart <span className="text-primary">is empty.</span>{" "}
            </h1>
            <img
